...
const order = ({order}) => {
  ...
  return (
    <div className="container mx-auto py-8 px-4 md:px-16 lg:px-24">
      ...
      <p>Your Order has been placed successsfully you will receive an email confirmation shortly</p>
      <div className="mt-6 p-12 border rounded-lg bg-gray-100">
         <h3 className="text-lg font-semibold mb-2">Order Summary</h3>
         <p>Order Number: {order && order.orderNumber}
        </p>
         <div className="mt-4">
